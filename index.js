...
module.exports = function(extensions){
    ...
    return through.obj(function(file, enc, cb) {
        ...
        try {
            var pictureRender = function (url, imgTag, classes) {
                return '<picture '+classes+' ><source srcset="' + url + '" type="image/webp">' + imgTag + '</picture>';
            }
            ...
            const data = file.contents.toString()
                    ...
                    .map(function(line){
                        ...
                        if((line.indexOf('<img') + 1) && !inPicture){
                            ...
                            // Компилим <picture/>
                            var newHTML = pictureRender(newUrl,imgTag, regexpArray[1]);
